...
async function getPayPalAccessToken() {
  ...
  const auth = Buffer.from("AZra4XxHWmkPeznpQeY0NNLwhDZ-qoRIzUe4FFCPmdnDe8il-TyXrOByJwlX5jCSLWnTTPHYqU_ASubf" + ':' + "ELDyFDnOs23ljMIOocc2sjT2CWxC0zmjmA40fl-30KqeIEvXNZtIUbvRZxusK6PKm_4eZqYtOAaXaaqM").toString(
    'base64'
  );
